...
class solicitudController:
    ...
    def create_Solicitud(self, solicitud:Creasoli):   
        try:
            ...
            cursor.execute("INSERT INTO solicitud (idUsuario, IdTipoSolicitud,idpersonaAsignada, Asunto, FechaCreacion, estado) VALUES (%s, %s,%s, %s, %s, %s)", (solicitud.idUsuario, solicitud.IdTipoSolicitud,0, solicitud.Asunto, solicitud.FechaCreacion,'pendiente'))
            # Commit your changes
            conn.commit()
